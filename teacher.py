...
class Teacher(People):
    ...
    def sign_a_ticket(self, ticket):
        if self.decan:
            ...
            # Exception мы не выбрасываем, так как это очень ШИРОКИЙ класс исключения. Посмотри
            # видос на диске про дифференциацию исключений, это исключение будет достаточно сложно отлавливать
